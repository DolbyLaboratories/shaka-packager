...
void AddVideoInfo(const VideoStreamInfo* video_stream_info,
  ...
  video_info->set_supplemental_profile(video_stream_info->supplemental_profile());
  ...
  if (video_stream_info->colour_primaries() > 0) {
    video_info->set_colour_primaries(video_stream_info->colour_primaries());
  }
